...
class IsStackableDiscountTest extends TestCase
{
    use RefreshDatabase;

    public function testStackableDiscountsShowUp(): void
    {
    ...
    public function testNonStackableDiscountsAreMissing(): void
    {
        Discount::factory()->create([
            'entity' => CustomerRevenueDiscount::class,
            'priority' => 1,
